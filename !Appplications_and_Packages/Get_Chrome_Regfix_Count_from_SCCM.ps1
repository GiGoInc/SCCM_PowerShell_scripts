...
$SQL_Queryx86 = "SELECT DISTINCT  
 ...
 WHERE ARP.DisplayName0 = 'Google Chrome' AND ARP.InstallDate0 = '20240101'
...
$Log = "D:\Powershell\!Parallized_Scripts\Google_Chrome_Installs\Get_Chrome_Regfix_Count_from_SCCM_Results--$ADate.csv"
...
ForEach ($SQL_Query in $SQL_Querys)
{
    ...
    #    $V4 = $V4.PadLeft(3,'0')
    #    $NewVer = "$V1.$V2.$V3.$V4"
    #    If (($version -eq '121.0.6167.112' -and $InstalledDate -eq '20240101') -or ($version -eq '121.0.6167.111' -and $InstalledDate -eq '20240101'))
    #    {
