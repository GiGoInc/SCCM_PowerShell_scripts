...
$scriptblock = {Invoke-WmiMethod -Namespace root\CCM -Class SMS_Client -Name TriggerSchedule -ArgumentList "{00000000-0000-0000-0000-000000000108}"}


# Execute SCCM Client Actions
Invoke-Command -ComputerName $computer -ScriptBlock $scriptblock -Credential $cred
