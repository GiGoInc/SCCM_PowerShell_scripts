...
.DESCRIPTION
.EXAMPLE
    Get-CollectionsRefreshSchedules.ps1 -SiteCode XX1 -SiteServer SERVER -CSV -output D:\Powershell\!SCCM_PS_scripts\!Collections\SCCM_Get_CollectionsRefreshSchedules.csv
.EXAMPLE
    Get-CollectionsRefreshSchedules.ps1 -SiteCode XX1 -SiteServer SERVER -HTML -output D:\Powershell\!SCCM_PS_scripts\!Collections\SCCM_Get_CollectionsRefreshSchedules.html
.NOTES
