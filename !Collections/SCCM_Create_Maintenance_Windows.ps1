...
Change all the Maintenace Windows collections to a standard nameing convention like "MaintWindowCollection - (
 ...
 all the Maintenance windows names on the collections to a standard like "Maintenance Window"
...
$Collection = Get-CMDeviceCollection -Name "RemoteLocale Workstations - 3rd Friday"
Set-CMMaintenanceWindow -CollectionID XX100083 -Schedule $Schedule -Name "3rd Friday"
...
{
	Get-CMMaintenanceWindow -CollectionId XX100083
