...
.DESCRIPTION
.EXAMPLE
    Get-CollectionsRefreshSchedules.ps1 -SiteCode SS1 -SiteServer SCCMSERVER -CSV -output D:\Powershell\!SCCM_PS_scripts\!Collections\SCCM_Get_CollectionsRefreshSchedules.csv
.EXAMPLE
    Get-CollectionsRefreshSchedules.ps1 -SiteCode SS1 -SiteServer SCCMSERVER -HTML -output D:\Powershell\!SCCM_PS_scripts\!Collections\SCCM_Get_CollectionsRefreshSchedules.html
.NOTES
