...
ruleCheck.Name = "Allow user control over installs"
ruleCheck.ExpectedValue = "Disabled"
Set regCheckObj = new RegCheck
regCheckObj.Hive = "HKEY_LOCAL_MACHINE"
regCheckObj.KeyPath = "Software\Policies\Microsoft\Windows\Installer"
regCheckObj.ValueName = "EnableUserControl"
