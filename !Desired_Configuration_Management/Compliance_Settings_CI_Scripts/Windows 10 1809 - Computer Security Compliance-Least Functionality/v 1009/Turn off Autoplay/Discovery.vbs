...
ruleCheck.Name = "Turn off Autoplay"
ruleCheck.ExpectedValue = "Enabled"
CheckFooSetting = CheckFooSetting & ruleCheck.GetCheckResult(False) & ";  "

Set ruleCheck = new RuleCheck
ruleCheck.Name = "Turn off Autoplay on"
ruleCheck.ExpectedValue = "All drives"
Set regCheckObj = new RegCheck
regCheckObj.Hive = "HKEY_LOCAL_MACHINE"
regCheckObj.KeyPath = "Software\Microsoft\Windows\CurrentVersion\Policies\Explorer"
regCheckObj.ValueName = "NoDriveTypeAutoRun"
regCheckObj.ExpectedValue = "255"
