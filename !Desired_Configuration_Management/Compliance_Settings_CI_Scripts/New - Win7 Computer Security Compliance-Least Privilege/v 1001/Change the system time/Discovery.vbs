WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeSystemtimePrivilege' and precedence=1", "AccountList", "LOCAL SERVICE, Administrators")
