WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeIncreaseQuotaPrivilege' and precedence=1", "AccountList", "Administrators, Local Service, Network Service")
