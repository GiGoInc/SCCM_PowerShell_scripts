WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeChangeNotifyPrivilege' and precedence=1", "AccountList", "Users, NETWORK SERVICE, LOCAL SERVICE, Administrators")
