WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeIncreaseWorkingSetPrivilege' and precedence=1", "AccountList", "Administrators, Local Service")
