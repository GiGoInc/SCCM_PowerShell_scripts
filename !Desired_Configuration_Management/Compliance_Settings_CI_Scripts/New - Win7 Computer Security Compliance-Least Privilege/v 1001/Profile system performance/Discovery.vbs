WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeSystemProfilePrivilege' and precedence=1", "AccountList", "NT SERVICE\WdiServiceHost,Administrators")
