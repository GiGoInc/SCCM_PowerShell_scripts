WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeChangeNotifyPrivilege' and precedence=1", "AccountList", "Administrators, Authenticated Users, Backup Operators, Local Service, Network Service")
