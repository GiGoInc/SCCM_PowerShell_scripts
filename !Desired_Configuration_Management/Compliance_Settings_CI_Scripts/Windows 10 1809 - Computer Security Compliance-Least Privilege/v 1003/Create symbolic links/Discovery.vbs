WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeCreateSymbolicLinkPrivilege' and precedence=1", "AccountList", "Administrators")
