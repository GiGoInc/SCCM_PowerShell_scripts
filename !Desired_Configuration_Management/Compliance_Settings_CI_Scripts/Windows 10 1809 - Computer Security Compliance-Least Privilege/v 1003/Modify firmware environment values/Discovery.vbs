WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeSystemEnvironmentPrivilege' and precedence=1", "AccountList", "Administrators")
