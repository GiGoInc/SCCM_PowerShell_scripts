WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeIncreaseBasePriorityPrivilege' and precedence=1", "AccountList", "Administrators")
