...
ruleCheck.Name = "Enable insecure guest logons"
ruleCheck.ExpectedValue = "Disabled"
Set regCheckObj = new RegCheck
regCheckObj.Hive = "HKEY_LOCAL_MACHINE"
regCheckObj.KeyPath = "Software\Policies\Microsoft\Windows\LanmanWorkstation"
regCheckObj.ValueName = "AllowInsecureGuestAuth"
