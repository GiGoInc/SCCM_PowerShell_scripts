WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeCreatePagefilePrivilege' and precedence=1", "AccountList", "Administrators")
