WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeCreateGlobalPrivilege' and precedence=1", "AccountList", "Administrators, SERVICE, LOCAL SERVICE, NETWORK SERVICE")
