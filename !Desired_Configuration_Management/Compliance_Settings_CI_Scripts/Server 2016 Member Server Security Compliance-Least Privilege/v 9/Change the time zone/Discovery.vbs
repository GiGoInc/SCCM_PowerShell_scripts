WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeTimeZonePrivilege' and precedence=1", "AccountList", "LOCAL SERVICE, Administrators")
