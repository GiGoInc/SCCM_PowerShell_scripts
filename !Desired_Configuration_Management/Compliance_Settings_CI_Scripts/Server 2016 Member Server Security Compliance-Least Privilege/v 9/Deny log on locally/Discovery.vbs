WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeDenyInteractiveLogonRight' and precedence=1", "AccountList", "G-RESTRICTINTERACTIVE-LOGON")
