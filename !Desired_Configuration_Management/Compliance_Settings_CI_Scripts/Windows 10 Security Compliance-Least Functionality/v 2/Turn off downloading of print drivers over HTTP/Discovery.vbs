...
ruleCheck.Name = "Turn off downloading of print drivers over HTTP"
ruleCheck.ExpectedValue = "Enabled"
Set regCheckObj = new RegCheck
regCheckObj.Hive = "HKEY_LOCAL_MACHINE"
regCheckObj.KeyPath = "Software\Policies\Microsoft\Windows NT\Printers"
regCheckObj.ValueName = "DisableWebPnPDownload"
regCheckObj.ExpectedValue = "1"
