...
ruleCheck.Name = "Untrusted Font Blocking"
ruleCheck.ExpectedValue = "Enabled"
CheckFooSetting = CheckFooSetting & ruleCheck.GetCheckResult(False) & ";  "

Set ruleCheck = new RuleCheck
ruleCheck.Name = "Mitigation Options"
ruleCheck.ExpectedValue = "Block untrusted fonts and log events"
Set regCheckObj = new RegCheck
regCheckObj.Hive = "HKEY_LOCAL_MACHINE"
regCheckObj.KeyPath = "SOFTWARE\Policies\Microsoft\Windows NT\MitigationOptions"
regCheckObj.ValueName = "MitigationOptions_FontBocking"
regCheckObj.ExpectedValue = "1000000000000"
