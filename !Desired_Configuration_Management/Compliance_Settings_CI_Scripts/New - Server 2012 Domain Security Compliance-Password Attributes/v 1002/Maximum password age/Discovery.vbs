Option Explicit
WScript.Echo CheckRange("root\rsop\computer", "RSOP_SecuritySettingNumeric", "Setting", "KeyName='MaximumPasswordAge' And precedence=1", "60")
Function CheckRange(wmiNamespace, wmiClass, wmiProperty, wmiWhere, ExpectedValue)
 On Error Resume Next
 Err.Clear

 ' if "60" = "No Key", CInt() will failed, set ExpectedValue = -1 in that case.
