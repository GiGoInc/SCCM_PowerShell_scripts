WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeNetworkLogonRight' and precedence=1", "AccountList", "Users, Administrators")
