WScript.Echo ValidateSetting("root\rsop\computer", "RSOP_UserPrivilegeRight", "UserRight='SeAuditPrivilege' and precedence=1", "AccountList", "Local Service, Network Service")
