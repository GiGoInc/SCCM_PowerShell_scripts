...
---     and stat.MessageID >= 30000
---     and stat.MessageID <= 30005
---     and (DateDiff(day, stat.Time, GetDate()) < 183)
...
$statmsgs | Select-Object SeverityName, MessageID, Component, MachineName, Time, SiteCode, FullMsgString | Export-Csv $csv -notypeinformation
$statmsgs | Select-Object SeverityName, MessageID, Component, MachineName, Time, SiteCode, FullMsgString | Out-GridView
$statmsgs | Group-Object component | sort count -descending | Out-GridView
