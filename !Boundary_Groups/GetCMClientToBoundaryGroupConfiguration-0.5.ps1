...
.NOTES 
    ...
    0.2        Scott Breen      Added ability to list possible IP ranges
    0.3        Scott Breen      Efficiency improvements
    0.4        Scott Breen      Updated to detect the difference between site assignment and content only boundaries
                                Auto provide possible IP range if device is not covered by a content boundary group
    0.5        Scott Breen      Updated before final release
#>
